...
const Navbar = () => {
  ...
  return (
    <div className=' flex justify-between items-center w-full h-20 text-white fixed bg-black px-4'>
        ...
        {nav && (<ul className=' flex flex-col justify-center items-center absolute top-0 left-0 w-full h-screen bg-gradient-to-b from-black to-gray-700 text-gray-400'>
        {
            links.map(({id,link}) => (
                <li key={id} className=' px-4 cusor-pointer capitalize py-6 text-4xl'>
