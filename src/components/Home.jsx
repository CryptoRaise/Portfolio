        ...
        <div className=' flex flex-col justify-center h-full'>
          ...
          I am a FULL Stack developer who builds web applications using MongoDB,
           ...
           and back-end development along with fullstack framework like Next js for dynamic and efficient applications.
            ...
            <Link href='#Projects' smooth duration={500} className=' group text-white w-fit px-6 py-3 my-2 flex items-center rounded-md bg-gradient-to-r from-cyan-500 to-blue-500 cursor-pointer'>
              Projects<span className= ' group-hover:rotate-90 duration-300'>
